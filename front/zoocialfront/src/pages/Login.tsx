            ...
            <div className="auth-form-container" style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', backgroundColor: '#ffffff' }}>
                <div style={{ width: '100%', maxWidth: '400px' }}>
                    ...
                    <div className="auth-header" style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                        <h1 className="auth-title" style={{ fontSize: '2rem', fontWeight: 800, color: '#000' }}>Welcome back!</h1>
                        <p className="auth-subtitle" style={{ color: '#666', fontSize: '0.95rem', marginTop: '0.5rem', lineHeight: '1.5' }}>
                            Simplify your workflow and manage your pets<br/>with Zoocial. Log in to continue.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <div style={{ textAlign: 'right', marginTop: '0.5rem' }}>
                                <a href="#" style={{ fontSize: '0.8rem', color: '#000', fontWeight: 600 }}>Forgot Password?</a>
                            </div>
                        </div>
                    ...
                    <div style={{ textAlign: 'center', fontSize: '0.9rem', color: '#64748b' }}>
                        Not a member? <Link to="/register" style={{ color: '#4ade80', fontWeight: 600 }}>Register now</Link>
                    </div>
                </div>
            </div>
            ...
            <style>{`
                @media (min-width: 1024px) {
                    .auth-sidebar.desktop-only {
                        ...
                        flex: 1;
                        background-color: #f0fdf4; /* Light green tint from reference */
                        align-items: center;
